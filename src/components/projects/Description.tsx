    ...
    <>
      {title === "shoopy" ? (
        <div className="w-11/12 p-8 bg-white/10 rounded-3xl flex flex-col items-center">
          ...
          <div className="p-8 bg-white/60 rounded-2xl mt-4 flex flex-col gap-2">
            <span className="text-xl font-bold">프로젝트 기간</span>
            <p className="text-lg">
              2023.04 ~ <br /> 2023.04 <br /> 개인 프로젝트 <br /> (1인 / 2주)
            </p>
          </div>
        </div>
      ) : title === "omu" ? (
        <div className="w-11/12 p-8 bg-white/10 rounded-3xl flex flex-col items-center">
          ...
          <div className="w-5/6 flex flex-col gap-2 items-center justify-between">
